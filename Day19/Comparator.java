...
class Employee implements Comparator <Employee> {
    ...
    public class ComparatorExample{
        public static void main(String[] args){
            ...
            Employee e1=new Employee(5,"shreya",90000.0);
            Employee e2=new Employee(3,"sritha",80000.0);
            Employee e3=new Employee(2,"keerthana",70000.0);
            Employee e4=new Employee(1,"omkar",80000.0);
            Employee e5=new Employee(4,"dattu",70000.0);
            ar.add(e1);
            ar.add(e2);
            ar.add(e3);
            ar.add(e4);
